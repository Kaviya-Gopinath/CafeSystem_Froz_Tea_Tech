...
count: number = 4;
    ...
    getAllMenu()
    {
      this.hasSearchName = this.activeRoute.snapshot.paramMap.has("fname");
        ...
        this.FrozTeaTechService.getMenuByFname(this.searchName).subscribe(data=>{
          console.log(data);
          this.menu= data;
        })
      }
      else{
      this.FrozTeaTechService.getAllMenu().subscribe(data=>{
        console.log(data);
        this.menu=data;
      });
    }
    ...
    deleteMenu(id:number):void{
      ...
      if(confirm("Do you want to delete ?")){
        this.FrozTeaTechService.deleteMenu(id).subscribe(data=>{
          console.log(data);
          this.getAllMenu();
        })
      };
