    ...
    getAllCustomer()
  {
    this.hasSearchName = this.activeRoute.snapshot.paramMap.has("username");
       ...
       {this.searchName  = this.activeRoute.snapshot.paramMap.get("username");
        ...
        this.FrozTeaTechService.getCustomerByUsername(this.searchName).subscribe(data=>{
        console.log(data);
        this.customer= data;
        })
      }
      else{
      this.FrozTeaTechService.getAllCustomer().subscribe(data=>{
        console.log(data);
        this.customer=data;
      });
    }
    ...
    deleteCustomer(id:number):void{
      ...
      if(confirm("Do you want to delete ?")){
        this.FrozTeaTechService.deleteCustomer(id).subscribe(data=>{
          console.log(data);
          this.getAllCustomer();
        })
      };
