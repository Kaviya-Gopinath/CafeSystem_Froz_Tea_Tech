...
export class AddOrderComponent implements OnInit {
  ...
  constructor(private activeRoute: ActivatedRoute, private http: HttpClient, public router: Router, private FrozTeaTechservice: FrozTeaTechService) { }
  ...
  placeOrder() {
    ...
    this.FrozTeaTechservice.orderMenu(itemId, customerId, quan).subscribe(
